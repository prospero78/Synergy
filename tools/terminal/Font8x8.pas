...
type
   ...
   public 
      ...
      d9: тМасЛит = (0, 62, 65, 65, 63, 1, 65, 62);
   end;
   /// Специальные литеры
   tSpez = class
   public 
      ...
      /// минус
      minus: тМасЛит = (0, 0, 0, 127, 0, 0, 0, 0);
      /// плюс
      ...
      akk: тМасЛит =  (0, 0, 24, 24, 24, 24, 0, 24);
      /// решётка
      ...
      /// слэш
      slh: тМасЛит = (0, 1, 2, 4, 8, 16, 32, 64);
      /// обратный слэш
      ...
      /// собака
      hun: тМасЛит = (0, 62, 65, 77, 85, 77, 66, 56);
      /// вертикальная черта (поток)
      vert: тМасЛит = (0, 16, 16, 16, 16, 16, 16, 16);
   end;
   /// Английские буквы
   tLetEn = class
   public 
